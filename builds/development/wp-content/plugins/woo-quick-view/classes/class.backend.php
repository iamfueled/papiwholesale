...
function wcqv_quick_view_options() {
	...
	echo '<div class="wcqv_warn_msg">
    <img src="'.$this->wcqv_plugin_dir_url  .'/img/warn.png""> <b>Woo Quick View Lite</b>
     is a fully functional but limited version of <b><a href="http://www.ciphercoin.com/woocoomerce-quick-view/" target="_blank">Woo Quick View Pro</a></b> (Free). Consider upgrading to get access to all premium features and premium support.
    </div>';
	...
	<tr valign='top'>
	<th><lable><p style="float:left;color:#168A0A;padding-right:5px;">
	<?php _e('Pro* ','woo-quick-view'); ?></p>
	<p><a href="http://www.ciphercoin.com/woocoomerce-quick-view/" target="_blank"><?php _e('Enable Quick View Icon','woo-quick-view'); ?></a></p>
	</lable></th>
	<td scop='row'>
